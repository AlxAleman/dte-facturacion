// src/components/dte/forms/types/NotaDebito.jsx
// Formulario específico para Nota de Débito (Tipo 06)

import React from 'react';
import { FileText, MinusCircle, AlertTriangle } from 'lucide-react';
...
// Función para obtener datos iniciales específicos para Nota de Débito
function getInitialData() {
  ...
  return {
    identificacion: {
      ...
      tipoDte: "06", // 06=Nota de Débito
      codigoGeneracion: generateUUID(),
      numeroControl: "DTE-06-00000001-000000000000001",
    ...
    receptor: {
      nit: "", // Para ND solo se usa NIT, no tipoDocumento/numDocumento
      nrc: "",
      nombre: "",
      codActividad: actividadEconomicaDefault.codigo,
      descActividad: actividadEconomicaDefault.valor,
    ...
    resumen: {
      ...
      subTotal: 0,
      ivaRete1: 0,
      ivaPerci1: 0, // Campo específico para ND
      reteRenta: 0,
    ...
    // Campos específicos para Nota de Débito
    ...
    // Información adicional para Nota de Débito
    extension: {
      tipoNota: "01", // 01=Intereses, 02=Gastos por cobrar, 03=Cambio de valor, 04=Otros
      motivo: "",
      descripcion: ""
    }
  };
...
const NotaDebito = ({ onDataChange, initialData }) => {
  const [formData, setFormData] = React.useState(initialData || getInitialData());
  const [isInitialized, setIsInitialized] = React.useState(false);

  // Campos requeridos específicos para Nota de Débito
  ...
  return (
    <div className="space-y-6">
      {/* Header específico para Nota de Débito */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-red-700">
              Documento para cargos adicionales o correcciones
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            >
              <option value="01">01 - Intereses</option>
              <option value="02">02 - Gastos por cobrar</option>
              <option value="03">03 - Cambio de valor</option>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              rows={3}
              placeholder="Descripción detallada del motivo de la nota de débito..."
            />
          </div>
        </div>
      </div>
